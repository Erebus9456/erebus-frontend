...
class AppThemeData {
  ...
  final Color
  backgroundText; // Text color on the main background (titles, body)
  ...
  ThemeData toThemeData() {
    return ThemeData(
      ...
      colorScheme: ColorScheme.dark(
        ...
        // Accent Text
        onPrimary: background.computeLuminance() > 0.5
            ? Colors.black
            : Colors.white,
...
AppThemeData getThemeByName(String themeName) {
  ...
  if (constants == null) {
    print(
      'Theme "$themeName" not found. Falling back to default: $kDefaultThemeNameReadable.',
    );
...
List<AppThemeData> getAllThemes() {
  return _orderedThemeNames
      .map((themeName) => getThemeByName(themeName))
      .toList();
}
